<div class="page-wrapper">
    <!-- Rate doctor after appointment has been approved -->
    <?php

    require('doctor_to_rate.php');
    ?>
    <div class="content">
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <div class="doctor-img">
                                <a class="avatar" href="?view=doctor-profile&id=<?php echo ($doctor["doctor_id"]) ?>"><img alt="" style='height:100%; width:100%; border-radius:100%;' src="assets/img/<?php echo ($doctor['profile_image']) ?>"></a>
                            </div>
